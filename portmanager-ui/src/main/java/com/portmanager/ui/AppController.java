...
public class AppController {
    ...
    @FXML public TableColumn<ShipRow, String> draftColumn;
    @FXML public TableColumn<ShipRow, String> durationColumn;
    ...
    @FXML
    private void onShowLastPlan() {
        if (lastPlan != null) {
            renderPlan(lastPlan);
            renderMetrics(lastPlan.getMetrics(), totalLabel, delayedLabel, utilLabel);
            statusLabel.setText("Last generated by ML plan is shown");
        } else {
            statusLabel.setText("There is no saved plan");
        }
    }
    ...
    public void initialize() {
        ...
        weatherLabel.setText("Weather Events: —");
        closuresLabel.setText("Terminal Closures: —");
    }
    ...
    private void onRefreshPlan() {
        ...
        if (response.isPresent()) {
            PlanResponse lastSinglePlan = response.get();
